#pragma once
// Online Incremental Update — Algorithm 1 (paper §3.5)
//
// One-step proximal policy gradient restricted to the low-rank subspace:
//
//   L_t = −λ1·r_t  +  λ2·‖a_t − a_{t-1}‖²  +  λ3·‖φ(s_t,a_t)‖²   (Eq.10)
//
...
public:
    ...
    // Execute one online update step (Algorithm 1, lines 9-13).
    ...
    // EMA history update  h_t = EMA(h_{t-1}, s_t)  (Algorithm 1, line 13)
